...
const html = 'file:///' + p.resolve(__dirname, 'graphic-vs-all.html').split(p.sep).join('/');
const png = p.resolve(__dirname, '..', 'brand', 'styx-vs-luna-zec-v2.png');
const r = spawnSync('C:/Program Files/Google/Chrome/Application/chrome.exe', [
  ...
  '--window-size=2400,2300', '--virtual-time-budget=6000',
  '--screenshot=' + png, html,
