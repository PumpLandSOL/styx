...
const html = 'file:///' + p.resolve(__dirname, 'graphic-zec.html').split(p.sep).join('/');
const png = p.resolve(__dirname, '..', 'brand', 'styx-vs-zec.png');
const r = spawnSync('C:/Program Files/Google/Chrome/Application/chrome.exe', [
  ...
  '--window-size=2400,1600', '--virtual-time-budget=6000',
  '--screenshot=' + png, html,
