...
const html = 'file:///' + p.resolve(__dirname, 'graphic-triad.html').split(p.sep).join('/');
const png = p.resolve(__dirname, '..', 'brand', 'styx-vs-luna-zcash.png');
const r = spawnSync('C:/Program Files/Google/Chrome/Application/chrome.exe', [
  ...
  '--window-size=2400,1720', '--virtual-time-budget=6000',
  '--screenshot=' + png, html,
