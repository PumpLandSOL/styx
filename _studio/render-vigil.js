...
const html = 'file:///' + p.resolve(__dirname, 'graphic-vigil.html').split(p.sep).join('/');
const png = p.resolve(__dirname, '..', 'brand', 'styx-vigil.png');
const r = spawnSync('C:/Program Files/Google/Chrome/Application/chrome.exe', [
  ...
  '--window-size=2400,1480', '--virtual-time-budget=6000',
  '--screenshot=' + png, html,
